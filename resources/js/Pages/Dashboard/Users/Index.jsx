                    ...
                    {isSuperAdmin && (
                        <>
                            <button
                                ...
                                className="flex-1 flex items-center justify-center gap-1.5 py-3 text-primary-600 hover:bg-primary-50 dark:hover:bg-primary-950/50 text-sm font-medium transition-colors"
                            ...
                            <button
                                ...
                                className="flex-1 flex items-center justify-center gap-1.5 py-3 text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-950/50 text-sm font-medium transition-colors"
...
export default function Index() {
    ...
    const isSuperAdmin = auth?.user?.roles?.some(r => r.name === "super-admin") || auth?.user?.store_id === null;

    const handleImpersonate = (user) => {
        Swal.fire({
            title: "Login sebagai User",
            text: `Anda akan login sebagai ${user.name}. Klik "Kembali ke Superadmin" untuk kembali.`,
            icon: "info",
    ...
    const handleResetPassword = (user) => {
        Swal.fire({
            title: "Reset Password",
            text: `Reset password untuk ${user.name}? Password baru akan di-generate otomatis.`,
            icon: "warning",
            showCancelButton: true,
