...
export default function Menu() {
    ...
    const isGlobalAdmin = auth?.globalAdmin || false;

    // define menu navigations
    const menuNavigation = [
        // Platform section — only visible to global admin (super-admin without store)
        ...(isGlobalAdmin ? [{
            title: "Platform",
            details: [
                {
                    ...
                    active: url.startsWith("/dashboard/super-admin"),
            ...
            details: [
                {
                    ...
                    active: url.startsWith("/dashboard/subscription") && !url.startsWith("/dashboard/subscription/billing"),
                    icon: <IconCrown size={20} strokeWidth={1.5} />,
                    permissions: hasAnyPermission(["dashboard-access"]),
                },
                {
                    ...
                    active: url.startsWith("/dashboard/subscription/billing"),
